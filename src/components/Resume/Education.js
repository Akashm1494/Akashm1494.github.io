...
//       description:
//         "Spent 1300+ hours mastering algorithms, data structures, and full-stack development. Built projects using HTML, JavaScript, React, and Redux. Developed skills in remote pair-programming, GitHub workflows, and daily standups.",
//     },
//     {
...
//       description:
//         "Developed and deployed a mobile app using React Native. Built and optimized a scanner app for document management. Designed and developed 4 frontend websites with animations & responsive layouts. Customized and launched a WordPress website.",
//     },
//   ];
...
//                   <p className={styles.timeline_desc}>{edu.description}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//                   <p className={styles.timeline_desc}>{work.description}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
